...
A Simple Solution is to start from value 1 and check all values one by one 
if they can sum to values in the given array. 
...
(smallest possible outcome) and traverse the given array. 
